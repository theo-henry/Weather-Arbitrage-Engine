...
function buildCompareModeInstruction() {
  return [
    ...
    'Map general activities to the closest scored activity: outdoor exercise, tennis, hiking, or workouts -> run; outdoor meals, drinks, dates, picnics, markets, parks, or social plans -> social; photography, video, sightseeing, sunrise, sunset, or photo walk -> photo; walk, walking, stroll, bike, biking, cycling, commute, driving, car trips, bike commute, cycling to work, walking commute, school run, office trip, or travel across town -> commute; study, reading, focus, writing, or laptop work -> study.',
    ...
    'When duration is specified, preserve it exactly. Examples: 15 min = 15 minutes, 45-minute = 45 minutes, 1h 15m = 75 minutes. Do not round requested durations up to 30-minute or 60-minute blocks.',
...
function buildSystemInstruction(request: AssistantRequest) {
  ...
  const schedulerInstruction = [
    ...
    'Activity mapping for scheduling: map user activity words to the closest supported scored profile. Walk, walking, stroll, bike, biking, cycling, driving, travel, transit, and getting somewhere -> commute. Jogging, hiking, workouts, outdoor exercise, and tennis -> run. Photo walk, photography, camera, sightseeing, sunrise, and sunset photos -> photo. Outdoor meals, drinks, dates, picnics, markets, parks, and friends -> social. Reading, studying, writing, focus, laptop work, and deep work -> study.',
    'When you map a natural-language activity to a scored profile, still keep the user-facing title natural, e.g. "Walk", while using activity="commute" for tools and weather scoring.',
    'For commute-like requests, set commute_mode in account settings when the user specifies car, bike, or walking. For a walk or walking request, use commute_mode="walk"; for biking or cycling, use commute_mode="bike"; for driving, use commute_mode="car".',
    'If the user gives a flexible window such as "Saturday afternoon" or "tomorrow evening" instead of an exact clock time, use find_optimal_slots with the mapped activity, exact requested duration, date/window preference, and the current calendar. Present the best available slots. If the user explicitly asked to schedule/add it, draft the top slot with draft_create_event and ask for confirmation.',
    'Duration handling: preserve explicit durations exactly. Examples: 15 min = 15 minutes, 45-minute = 45 minutes, 1h 15m = 75 minutes. Do not round requested durations up to 30-minute or 60-minute blocks.',
